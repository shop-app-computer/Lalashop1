  ...
  return (
    <div className="space-y-4 text-sm">
      <div className="rounded-lg px-3 py-2 flex flex-wrap items-center gap-2">
        <h2 className="text-[13px] font-semibold text-gray-900">Refunded orders</h2>
          ...
          <table className="w-full text-[12px] tabular-nums">
            <thead className="text-[11px] text-gray-500 tracking-wide">
              <tr>
                ...
                <th className="px-4 py-2 text-left font-semibold">Refunded</th>
              ...
              {!loading && !error && refunds.map((r) => (
                <tr key={r._id}>
                  ...
                  <td className="px-4 py-2 text-right">
                    <Link href={`/orders/${r._id}`} title="View" className="inline-block text-gray-500 hover:text-black hover:bg-gray-100 rounded p-1">
