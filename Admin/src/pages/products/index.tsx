  ...
  return (
    <div className="space-y-4 text-sm">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <KPI label="All Products" value={stats ? stats.total.toLocaleString() : '—'} />
        <KPI label="Live" value={stats ? stats.active.toLocaleString() : '—'} tone="text-green-700" />
        <KPI label="Pending" value={stats ? stats.pending.toLocaleString() : '—'} tone="text-orange-700" />
        <KPI label="Banned" value={stats ? stats.banned.toLocaleString() : '—'} tone="text-red-700" />
      </div>
